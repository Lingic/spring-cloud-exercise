  ...
  <div class="container" style="width:100%;">
    ...
    <el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" label-width="100px" :rules="dataFormRules" ref="dataForm">
        <el-form-item label="编号" prop="stationNo" v-if="!operation">
          <el-input v-model="dataForm.stationNo" :disabled="true" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="检测站名称" prop="stationName">
        ...
        <el-form-item label="所在线路" prop="line">
          <el-input v-model="dataForm.line" auto-complete="off"></el-input>
        </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          {prop:"stationNo", label:"编号", minWidth:40,sortable:false},
          {prop:"stationName", label:"检测站名称", minWidth:40,sortable:false},
          {prop:"region", label:"所在区域", minWidth:40,sortable:false},
          {prop:"line", label:"所在线路", minWidth:40,sortable:false},
    ...
    methods: {
      findPage:function(data){
        ...
        if(data != null){
          ...
          this.$api.station.findPage(Object.assign(this.pageRequest,{name:this.filters.name})).then((res) => {
      ...
      handleDelete: function (data) {
      	this.$api.station.batchDelete(data.params).then(data!=null?data.callback:'')
      },
      // 显示新增界面
      handleAdd: function() {
        ...
        this.$refs.dataForm.validate((valid) => {
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {}).then(() => {
              ...
              if(this.operation){
                this.$api.station.save(params).then((res) => {
                ...
                this.$api.station.edit(params).then((res) => {
                  this.editLoading = false
                  this.$message({
                    message: '提交成功',
                    type: 'success'
